...
<CardGroup cols={2}>
  ...
  <Card title="XDR correlation demo" icon="link" href="/third-party-alert-case-demo">Use NDR detections and optional external alerts in one XDR investigation story.</Card>
